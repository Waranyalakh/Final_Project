        ...
        with mp_pose.Pose(min_detection_confidence=0.80, min_tracking_confidence=0.5, model_complexity = global_vars.MODEL_COMPLEXITY,static_image_mode = False,enable_segmentation = True) as pose: 
            ...
            while not global_vars.KILL_THREADS and capture.cap.isOpened():
                ...
                if results.pose_world_landmarks:
                    ...
                    # เพิ่มการ print เวลาปัจจุบัน (timestamp) ทุกครั้งที่มีการตรวจจับ
                    ...
                    # เพิ่มการ print ข้อมูลของ Landmark แต่ละจุดพร้อมค่า x, y, z ในรูปแบบที่อ่านง่าย
                    for i, landmark in enumerate(hand_world_landmarks.landmark):
                        print(f"Landmark {i}: x={landmark.x}, y={landmark.y}, z={landmark.z}")
                        self.data += "{}|{}|{}|{}\n".format(i, landmark.x, landmark.y, landmark.z*-1)
